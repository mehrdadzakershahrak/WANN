# SAC algorithm modified from ORIGINAL VERSION
# reference https://github.com/ksluck/Coadaptation/blob/master/RL/soft_actor.py

from rlkit.torch.sac.policies import TanhGaussianPolicy
from rlkit.torch.networks import FlattenMlp
import numpy as np
from .ref_rl_algorithm import RL_algorithm

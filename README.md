...
docstring for [baselines/ppo2/ppo2.py/learn()](ppo2/ppo2.py#L152) for the description of the ppo2 hyperparameters. 
...
For examples on how to load and display the training data, see [here](../../extern/baselines/docs/viz/viz.ipynb).
...
- [GAIL](/gail)
- [HER](her)
- [PPO1](/ppo1) (obsolete version, left here temporarily)
- [PPO2](ppo2) 
- [TRPO](trpo_mpi)
